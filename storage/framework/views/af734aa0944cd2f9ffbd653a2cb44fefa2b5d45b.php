    ...
    <section class="blog-section">
        ...
        <div class="blog-card-container">
            ...
            <div class="blog-card">
                ...
                <img src="<?php echo e(asset('data/images/pexels-ehsan-ahmadnejad-983436.jpg')); ?>" alt="" class="blog-img">
            ...
            <!-- 2nd  -->
            <div class="blog-card">
                <img src="<?php echo e(asset('data/images/pexels-pixabay-315999.jpg')); ?>" alt="" class="blog-img">
                <div class="blog-details">
                    <p class="blog-title">who are we?</p>
                    <p class="post-date">posted 3mins ago</p>
                </div>
            ...
            <!-- 3rd  -->
            <div class="blog-card">
                <img src="<?php echo e(asset('data/images/pexels-eberhard-grossgasteiger-1624504.jpg')); ?>" alt="" class="blog-img">
                <div class="blog-details">
                    <p class="blog-title">who are we?</p>
                    <p class="post-date">posted 3mins ago</p>
                </div>
            ...
            <!-- fourth  -->
            <div class="blog-card">
                <img src="<?php echo e(asset('data/images/pexels-johannes-plenio-2080961.jpg')); ?>" alt="" class="blog-img">
                <div class="blog-details">
                    <p class="blog-title">who are we?</p>
                    <p class="post-date">posted 3mins ago</p>
                </div>
    ...
    <section class="top-design-section">
        ...
        <div class="design-card-container">
            ...
            <div class="design-card">
                ...
                <img src="<?php echo e(asset('data/images/pexels-riciardus-228095.jpg')); ?>" alt="" class="design-img">
                ...
                <div class="design-text-container">
                    ...
                    <div class="design-post-date">
                        ...
                        <div class="icon-container">
                            <img src="<?php echo e(asset('data/images/share-icon-removebg-preview.png')); ?>" alt="" class="share-icon">
                            <img src="<?php echo e(asset('data/images/calender2-removebg-preview.png')); ?>" alt="" class="icon">
                            <p>27th 02 2022</p>
                        </div>
                    </div>
            ...
            <div class="design-card">
                <img src="<?php echo e(asset('data/images/pexels-ehsan-ahmadnejad-983436.jpg')); ?>" alt="" class="design-img">
                <div class="design-text-container">
                    <h1>the beauty of nature</h1>
                    <div class="design-post-date">
                        <h2>coding</h2>
                        <div class="icon-container">
                            <img src="<?php echo e(asset('data/images/share-icon-removebg-preview.png')); ?>" alt="" class="share-icon" alt="" class="icon">
                            <img src="<?php echo e(asset('data/images/calender2-removebg-preview.png')); ?>" alt="" class="icon">
                            <p>27th 02 2022</p>
                        </div>
                    </div>
            ...
            <div class="design-card">
                <img src="<?php echo e(asset('data/images/pexels-mauricio-artieda-609554.jpg')); ?>" alt="" class="design-img">
                <div class="design-text-container">
                    <h1>the beauty of nature</h1>
                    <div class="design-post-date">
                        <h2>coding</h2>
...
<?php /**PATH C:\Users\user\Documents\Work\myportfolio\resources\views/blog.blade.php ENDPATH**/ ?>
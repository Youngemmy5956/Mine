...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('data/css/project.css')); ?>">
...
<body>
    ...
    <section class="top-design-section">
        ...
        <div class="design-card-container">
            <div class="design-card">
                <img src="<?php echo e(asset('data/images/pexels-aarti-vijay-2693529.jpg')); ?>" alt="" class="design-img">
        ...
        <div class="design-card-container">
            <div class="design-card">
                <img src="<?php echo e(asset('data/images/pexels-alex-azabache-5117913.jpg')); ?>" alt="" class="design-img">
                <div class="design-text-container">
                    <h1>the beauty of nature</h1>
                    <div class="design-post-date">
                        <h2>order</h2>
        ...
        <div class="design-card-container">
            <div class="design-card">
                <img src="<?php echo e(asset('data/images/pexels-eberhard-grossgasteiger-1624504.jpg')); ?>" alt="" class="design-img">
                <div class="design-text-container">
                    <h1>the beauty of nature</h1>
                    <div class="design-post-date">
                        <h2>order</h2>
    ...
    <section class="top-design-section">
        ...
        <div class="design-card-container">
            <div class="design-card">
                <img src="<?php echo e(asset('data/images/pexels-nathan-cowley-2055957.jpg')); ?>" alt="" class="design-img">
                <div class="design-text-container">
                    <h1>the beauty of nature</h1>
                    <div class="design-post-date">
                        <h2>order</h2>
        ...
        <div class="design-card-container">
            <div class="design-card">
                <img src="<?php echo e(asset('data/images/pexels-jaime-reimer-2662116.jpg')); ?>" alt="" class="design-img">
                <div class="design-text-container">
                    <h1>the beauty of nature</h1>
                    <div class="design-post-date">
                        <h2>order</h2>
...
<?php /**PATH C:\Users\user\Documents\Work\myportfolio\resources\views/project.blade.php ENDPATH**/ ?>
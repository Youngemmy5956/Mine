    ...
    <header id="head">
        ...
        <nav class="navbar">
            <ul class="navlist">
                ...
                <li class="tab">
                    <a href="<?php echo e(route("index")); ?>/#service" class="link">service</a>
                </li>
            </ul>
        </nav>
    ...
    <section class="contact-landpage">
        ...
        <div class="form-container">
            ...
            <form action="<?php echo e(route('contacts.store')); ?>" method="post" class="contact-form">
                ...
                <input type="email" placeholder="enter email" <?php echo e(old('email')); ?> name="email" class="contact-input" id="email-input" required>


                <label for="#name-input">Enter Name</label>
                <input type="text" placeholder="input your name"<?php echo e(old('name')); ?> name="name" class="contact-input" id="">
            ...
            <?php endif; ?>
                ...
                <input type="text" placeholder="enter Subject" <?php echo e(old('subject')); ?> name="subject" class="contact-input">


                <label for="#text-area">Enter Your Message</label>
                <textarea name="message" id="text-area" cols="30" <?php echo e(old("message")); ?> rows="10" class="text-area" placeholder="type your message here"></textarea>
        ...
        <div class="recommendation-card-container">
            ...
            <div class="recommendation-card">
                <div class="rank-container">
                    <img src="<?php echo e(asset('data/images/star-removebg-preview.png')); ?>" alt="" class="star">
                    <img src="<?php echo e(asset('data/images/star-removebg-preview.png')); ?>" alt="" class="star">
                    <img src="<?php echo e(asset('data/images/star-removebg-preview.png')); ?>" alt="" class="star">
                    <img src="<?php echo e(asset('data/images/star-removebg-preview.png')); ?>" alt="" class="star">
                    <img src="<?php echo e(asset('data/images/star-removebg-preview.png')); ?>" alt="" class="star">
                ...
                <div class="profile-info">
                    <img src="<?php echo e(asset('data/images/profile1.jpg')); ?>" alt="" class="profile-img">
                    <p>
...
<?php /**PATH C:\Users\user\Documents\Work\myportfolio\resources\views/contact.blade.php ENDPATH**/ ?>